...
#----------------------------------------------------------#
 ...
 dia_semana_ayer <- tools::toTitleCase(format(Sys.Date() - 1, "%A"))
#----------------------------------------------------------#
...
#----------------------------------------------------------# 
 ...
 nuevo_titulo <- paste0("PROMEDIO RATING HOGARES ", fecha_ayer, " CANAL 24 HORAS")
...
#----------------------------------------------------------# 
writeData(wb, sheet = 1, x = dia_semana_ayer, startCol = 3, startRow = 6)
...
##4.2. Diario ----
#----------------------------------------------------------# 
writeData(wb, sheet = 1, x = fecha_ayer, startCol = 3, startRow = 8)
...
writeData(wb, sheet = 1, x = fecha_ayer, startCol = 3, startRow = 11)
...
writeData(wb, sheet = 1, x = fecha_ayer, startCol = 3, startRow = 14)
...
#----------------------------------------------------------#
 ...
 # Seleccionar primero el intervalo final para intervalos_largos_c (24 HORAS CENTRAL)
 ...
 # Seleccionar luego el intervalo final para intervalos_largos (día completo), excluyendo el de 24 HORAS CENTRAL
